...
const stats = [
  { label: 'Test Accuracy', value: '89.42%', sub: 'on 20,000 images'       },
...
const features = [
  ...
  {
    icon: <Shield size={22} />,
    title: '140k Faces Trained',
    desc: 'Trained on 140,000 real and AI-generated face images from diverse sources, covering a wide range of deepfake generation techniques.',
  },
  {
